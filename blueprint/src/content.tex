...
\begin{theorem}[Cox Corollary 4.4]
  ...
  \leanok
  \uses{prop:p4_3}
  $\mathbb Z[\omega]$ is a PID and a UFD; irreducibles coincide with primes.
\end{theorem}
...
\begin{lemma}[Cox Lemma 4.8]
  ...
  \leanok
  \uses{def:eisenstein_norm}
  For a prime $\pi$ over $p$, $N(\pi) = p$ or $p^2$ (residue field $\mathbb
  Z[\omega]/\pi$ has $N(\pi)$ elements).
\end{lemma}
