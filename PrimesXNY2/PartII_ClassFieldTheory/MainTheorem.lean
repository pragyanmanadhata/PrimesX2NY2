...
namespace PrimesXNY2.MainTheorem

open PrimesXNY2.Order PrimesXNY2.RingClassField
...
theorem classPolynomial_natDegree (n : ℕ) :
    (classPolynomial n).natDegree =
      Nat.card (PrimesXNY2.Forms.FormClassGroup (-4 * n)) := sorry
